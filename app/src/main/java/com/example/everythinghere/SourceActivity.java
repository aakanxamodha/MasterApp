...
public class SourceActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        okBtn.setOnClickListener(v -> {
            ...
            Toast.makeText(SourceActivity.this, "Hello, " + userName + ". You like " + selectedArtist + ".", Toast.LENGTH_LONG).show();
        });
        ...
        resetBtn.setOnCheckedChangeListener((buttonView, isChecked) -> {
            if (isChecked) {
                ...
                if (!previousName.isEmpty()) {
                    ...
                    Toast.makeText(SourceActivity.this, "No name to restore", Toast.LENGTH_SHORT).show();
                }
            }
        });

        Button sBtn = findViewById(R.id.button12);
